 ...
 * .smelter/maintainer-standup/reviewed-prs.json with `{ reviewed_at,
...
if (!existsSync(profilePath)) {
  console.error('No profile.md found — run from repo root, with .smelter/maintainer-standup/profile.md present.');
  process.exit(1);
}

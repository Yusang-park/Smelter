 ...
 *
 * Reads gh_handle from .smelter/maintainer-standup/profile.md frontmatter.
 *
...
let ghHandle = '';
const profilePath = resolve(process.cwd(), '.smelter/maintainer-standup/profile.md');
...
let lastRunAt = '';
const statePath = resolve(process.cwd(), '.smelter/maintainer-standup/state.json');

 ...
 * state.json to .smelter/maintainer-standup/. Handles two formats:
 *
...
const BEGIN = 'SMELTER_STATE_JSON_BEGIN';
const END = 'SMELTER_STATE_JSON_END';
...
const baseDir = resolve(process.cwd(), '.smelter/maintainer-standup');
...
process.stdout.write(
  JSON.stringify({
    date,
    source,
    state_path: '.smelter/maintainer-standup/state.json',
    brief_path: `.smelter/maintainer-standup/briefs/${date}.md`,
  }) + '\n',
);

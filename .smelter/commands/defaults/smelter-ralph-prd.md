...
mkdir -p .smelter/ralph/{feature-slug}
```

### File 1: prd.md

**Output path**: `.smelter/ralph/{feature-slug}/prd.md`
...
**Output path**: `.smelter/ralph/{feature-slug}/prd.json`
...
| File | Purpose |
|------|---------|
| `.smelter/ralph/{feature-slug}/prd.md` | Full context - goals, UX, technical patterns |
| `.smelter/ralph/{feature-slug}/prd.json` | Story tracking - passes/fails per story |
...
1. **Full PRD** (`.smelter/ralph/{feature-slug}/prd.md`) - Goals, persona, UX, technical patterns
2. **Current Story** - From `.smelter/ralph/{feature-slug}/prd.json` with acceptance criteria
3. **Previous Learnings** - From `.smelter/ralph/{feature-slug}/progress.txt`
...
# Initialize progress
echo "# Ralph Progress Log\nStarted: $(date)\n---" > .smelter/ralph/{feature-slug}/progress.txt

# Run Ralph - specify the feature directory
@Smelter run ralph .smelter/ralph/{feature-slug}
```
```

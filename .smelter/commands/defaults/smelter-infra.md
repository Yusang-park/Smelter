...
Backed by the Smelter-native `smelter-infra` workflow. Pipeline `infra_ops`: investigate → investigate-review → infra-plan → infra-plan-review → infra-execute → verify → human-check.

...
```bash
# Option 1: Plan-based workflow (smelter-plan-to-merge)
ls -t $ARTIFACTS_DIR/../runs/*/plan-context.md 2>/dev/null | head -1

# Option 2: Issue-based workflow (smelter-fix-github-issue)
...
Then re-request the review: `@smelter review this PR`
```

...
The project's docs site is at `packages/docs-web/` (Starlight). User-facing docs published to smelter.diy. Repo-level docs include `CLAUDE.md`, `CONTRIBUTING.md`, and any `docs/` content.
...
- New configuration field in `.smelter/config.yaml`.

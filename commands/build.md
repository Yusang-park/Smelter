# Smelter: /build — Light Planning + Execution Command

Run the full 10-step workflow on $ARGUMENTS. Handles lightweight planning plus execution for new features, extensions, and non-trivial changes.
...
- Emit `[Magic Keyword: extend → /build]` yellow tag when skipped
...
| step-3-interview | User Interview | auto-route / continue |

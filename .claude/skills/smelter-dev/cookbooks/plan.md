...
Save to `.claude/smelter/plans/{slug}.plan.md` where `{slug}` is a kebab-case feature name.
...
**File**: `.claude/smelter/plans/{slug}.plan.md`
...
**Next Step**: `/smelter-dev implement .claude/smelter/plans/{slug}.plan.md`
```

...
**Next steps**:
- To write requirements: `/smelter-dev prd {recommended approach}`
- To plan implementation: `/smelter-dev plan {recommended approach}`
- For deeper codebase context: `/smelter-dev research {specific component}`

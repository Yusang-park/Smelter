...
The Codex CLI picks up all of these automatically because Smelter inherits the full process environment when spawning the CLI. No Smelter configuration needed — just set up the Codex CLI config once.
...
- id: github-analysis
  ...
  mcp: .smelter/mcp/github.json          # Path relative to repo root

...
| Topic | URL |
|-------|-----|
| Landing + install | [smelter.diy](https://smelter.diy) |
| Getting started (installation, quick start, concepts) | [smelter.diy/getting-started/](https://smelter.diy/getting-started/overview/) |
| The book (tutorial-style walkthrough) | [smelter.diy/book/](https://smelter.diy/book/) |
| Workflow authoring guide | [smelter.diy/guides/authoring-workflows/](https://smelter.diy/guides/authoring-workflows/) |
| Command authoring guide | [smelter.diy/guides/authoring-commands/](https://smelter.diy/guides/authoring-commands/) |
| Node type guides | [smelter.diy/guides/loop-nodes/](https://smelter.diy/guides/loop-nodes/), [/approval-nodes/](https://smelter.diy/guides/approval-nodes/), [/script-nodes/](https://smelter.diy/guides/script-nodes/) |
| Per-node features (Claude only) | [/hooks/](https://smelter.diy/guides/hooks/), [/mcp-servers/](https://smelter.diy/guides/mcp-servers/), [/skills/](https://smelter.diy/guides/skills/) |
| Global workflows/commands/scripts | [smelter.diy/guides/global-workflows/](https://smelter.diy/guides/global-workflows/) |
| Variables reference | [smelter.diy/reference/variables/](https://smelter.diy/reference/variables/) |
| CLI reference | [smelter.diy/reference/cli/](https://smelter.diy/reference/cli/) |
| Security model (env, sandbox, target-repo `.env` stripping) | [smelter.diy/reference/security/](https://smelter.diy/reference/security/) |
| Architecture | [smelter.diy/reference/architecture/](https://smelter.diy/reference/architecture/) |
| Configuration (`.smelter/config.yaml` full schema) | [smelter.diy/reference/configuration/](https://smelter.diy/reference/configuration/) |
| Troubleshooting | [smelter.diy/reference/troubleshooting/](https://smelter.diy/reference/troubleshooting/) |
| Adapter setup (Slack/Telegram/GitHub/Web/Discord/Gitea/GitLab) | [smelter.diy/adapters/](https://smelter.diy/adapters/) |
| Deployment (Docker, cloud, Windows) | [smelter.diy/deployment/](https://smelter.diy/deployment/) |
...
1. **Always run in background** — Smelter workflows are long-running. Always invoke the Bash tool with `run_in_background: true`. Use `/tasks` or the TaskOutput tool to check on progress.

2. **Always use worktree isolation** — Use the `--branch` flag unless the user explicitly requests otherwise. This creates an isolated environment so Smelter works without affecting the main branch.
...
smelter workflow list --json       # Machine-readable JSON
smelter isolation list             # Show active worktree environments
smelter isolation cleanup          # Remove stale worktrees (default: 7 days)
smelter isolation cleanup --merged # Remove branches merged into main
smelter complete <branch>          # Complete branch lifecycle (remove worktree + branches)
...
nodes:
  - id: first-node
    command: my-command    # Loads .smelter/commands/my-command.md
  - id: second-node
...
# Or reference a named script from .smelter/scripts/ or ~/.smelter/scripts/
- id: analyze
  script: analyze-metrics   # loads .smelter/scripts/analyze-metrics.py
  runtime: uv

...
- Save to `.smt/scientist/quick_summary.md`
...
**Output Location**: `.smt/scientist/quick_summary.md`
</Quick_Report_Format>
...
plt.savefig('.smt/scientist/figures/quick_hist.png')

# Bar chart
df['category'].value_counts().plot(kind='bar', figsize=(8, 4))
plt.title('Frequency by Category')
plt.savefig('.smt/scientist/figures/quick_bar.png')
```

**Save Location**: `.smt/scientist/figures/`

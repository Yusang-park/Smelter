# scripts/install.ps1
# Install Smelter CLI from GitHub Releases on Windows
#
# Usage: irm https://raw.githubusercontent.com/Yusang-park/Smelter/main/scripts/install.ps1 | iex
#
...
#   $env:VERSION = "v0.2.0"; irm https://raw.githubusercontent.com/Yusang-park/Smelter/main/scripts/install.ps1 | iex
#
#   # Install to custom directory
#   $env:INSTALL_DIR = "C:\tools\smelter"; irm https://raw.githubusercontent.com/Yusang-park/Smelter/main/scripts/install.ps1 | iex
...
function Show-Banner {
    ...
    Write-Host "  |      Smelter CLI Installer            |" -ForegroundColor Cyan
...
function Get-Arch {
    ...
    switch ($procArch.ToUpper()) {
        "ARM64"  {
            ...
            Write-Warn "Windows ARM64 binaries are not yet available for Smelter."
...
function Main {
    ...
    try {
        ...
        Write-Host "    smelter workflow list"
        Write-Host "    smelter workflow run smelter-explore `"What workflows are available?`""
        Write-Host ""

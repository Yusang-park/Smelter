...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    ...
    status: 'shipped',
    version: 'v0.2',
    description: 'Trigger Smelter workflows from any surface — Slack, Telegram, GitHub, Web UI, Discord — and deploy anywhere.',
    bullets: [
  ...
  },
  {
    ...
    status: 'shipped',
    version: 'v0.3',
    description: 'Run Smelter workflows with Pi — an open-source, multi-model coding agent. Breaks the Claude Code / Codex lock-in and opens Smelter to GPT, Gemini, Qwen, DeepSeek, and more.',
    bullets: [
      'Pi coding agent as a first-class Smelter provider',
  ...
  },
  {
    ...
    status: 'in-progress',
    version: 'v0.4',
    description: 'Getting started with Smelter should take under 5 minutes. A fully self-contained binary, one-line installers, and a first-run wizard that auto-detects your AI provider.',
    bullets: [
  ...
  },
  {
    ...
    status: 'next',
    version: 'v0.5',
    description: 'An open source registry for community-built Smelter workflows. Browse, install, and share workflows in one place.',
    bullets: [
      'smelter.diy/workflows — searchable, filterable directory',
      'WORKFLOW.md spec — standard format for shareable workflows',
      'One-command install: smelter workflow install <slug>',
  ...
  },
  {
    ...
    bullets: [
      ...
      'smelter workflow eval <name> — run evals from the CLI',
    ],
  ...
  },
  {
    ...
    status: 'planned',
    description: 'Connect Smelter to local inference servers and OpenAI-compatible API proxies — bring your own model.',
    bullets: [

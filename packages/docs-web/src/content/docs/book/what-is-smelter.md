---
title: What Is Smelter?
description: Smelter makes your AI coding assistant predictable by giving it a deterministic process to follow.
category: book
part: orientation
audience: [user]
sidebar:
...
Smelter makes your AI coding assistant predictable. Not by limiting it — by giving it a process to follow.
...
Smelter separates **what happens** from **how the AI thinks**.
...
Everything in Smelter builds on three ideas:
...
That's it. Everything else in Smelter builds on these three ideas.

---

## What Can You Do With Smelter?

Smelter ships with workflows for the most common development tasks:

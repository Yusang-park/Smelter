 ...
 * `.smelter/{commands,workflows}/defaults/` by `scripts/generate-bundled-defaults.ts`.
 ...
 *
 * Reads the build-time constant `BUNDLED_IS_BINARY` from `@smelter/paths`.
 ...
 * without resorting to `mock.module('@smelter/paths', ...)` — which is

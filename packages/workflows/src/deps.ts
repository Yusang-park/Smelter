 ...
 * Callers in @smelter/core satisfy these structurally — no adapter wrappers needed.
 *
 * Provider types are imported directly from @smelter/providers/types (contract layer).
...
// Backwards compat alias — deprecated, prefer direct import from @smelter/providers/types

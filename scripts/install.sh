#!/usr/bin/env bash
# scripts/install.sh
# Install Smelter CLI from GitHub releases
#
# Usage:
...
main() {
  ...
  echo ""
  echo "Get started:"
  echo "  smelter workflow list"
  echo "  smelter workflow run assist \"What workflows are available?\""
  echo ""
}

...
const LOOKUP = Object.freeze({
  // chain tests
  '확인하고 수정해줘': { mode: 'investigate', chained_modes: ['investigate', 'fix'], ...surfaceNone },
  '설계하고 구현해줘': { mode: 'think', chained_modes: ['think', 'implement'], ...surfaceNone },

  // single-mode tests
  '버그 고쳐줘': { mode: 'fix', chained_modes: null, ...surfaceBug },

  // session-scoping tests
  '사이드바 폭 파악해줘': { mode: 'investigate', chained_modes: null, ...surfaceNone },
  '이거 더 자세히 분석해줘': { mode: 'fix', chained_modes: null, ...surfaceBug },
  'OAuth 부분 추가로 확인': { mode: 'fix', chained_modes: null, ...surfaceBug },
  '새 feature 만들자 — 결제 모듈': { mode: 'think', chained_modes: null, ...surfaceNone },
  '사이드바 분석': { mode: 'investigate', chained_modes: null, ...surfaceNone },
  '로그인 분석': { mode: 'investigate', chained_modes: null, ...surfaceNone },
  ...
  '확인 좀 해줘': { mode: 'investigate', chained_modes: null, ...surfaceNone },
  'analyze this function': { mode: 'investigate', chained_modes: null, ...surfaceNone },
  ...
  '설계해줘': { mode: 'think', chained_modes: null, ...surfaceNone },
  '리팩토링할거야': { mode: 'think', chained_modes: null, ...surfaceNone },
  '새로운 기능 만들거야': { mode: 'think', chained_modes: null, ...surfaceNone },

 ...
 *
 *   1. Command set across tracked md files matches the canonical command set
 *      {brainstorm, fix, explore, verify, implement, infra}.
...
export const EXPECTED_COMMANDS = ['brainstorm', 'fix', 'explore', 'verify', 'implement', 'infra'];

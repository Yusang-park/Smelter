...
Commands available: brainstorm (deep planning), implement (full dev workflow), fix (bug fix / simple edit), infra (infrastructure/cloud/IaC operations), explore (read-only analysis), verify, cancel, queue.

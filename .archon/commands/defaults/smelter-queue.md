...
Queue a new intent **without interrupting current work**. In the Archon-native migration this is advisory guidance, not an enforced state transition.
...
| `/cancel hard` | not implemented in Archon-native queue | Use workflow abandon/cancel surfaces |
